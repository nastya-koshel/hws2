...
export const pureAddUser = (name: UserType['name'], setError: any, setName: any, addUserCallback: GreetingContainerPropsType['addUserCallback']) => {
    if (name.trim() === '') {
...
export const pureOnBlur = (name: UserType['name'], setError: any) => { // если имя пустое - показать ошибку
...
const GreetingContainer: React.FC<GreetingContainerPropsType> = ({
    ...
    const lastUserName = users.length > 0 ?  users[users.length-1].name : 'друг'// need to fix
